...
<div class="card card-nav-tabs" id="port-forwards">
	<div class="card-header" data-background-color="blue">
		<h4 class="title">
			<i class="fa fa-globe"></i> Country: <?= $f3->get('PARAMS.action') ?>
			<a href="/country/<?= $f3->get('PARAMS.action') ?>/json" class="pull-right mr-3 btn btn-primary">JSON</a>
			<a href="/country/<?= $f3->get('PARAMS.action') ?>/txt" class="pull-right mr-3 btn btn-primary">TXT</a>
		</h4>
		<p class="category">All domains hosted in this country.</p>
	</div>
